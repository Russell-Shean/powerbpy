...
<<<<<<< HEAD
  3. `x_position` - The x coordinate of where you want to put the chart on the page. Origin is page's top left corner.      
  4. `y_position` - The y coordinate of where you want to put the chart on the page. Origin is page's top left corner.       
  5. `height` - Height of chart on the page          
  6. `width` - Width of chart on the page      
=======
